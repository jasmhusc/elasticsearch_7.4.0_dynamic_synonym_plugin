...
public class DynamicSynonymPluginTest {
    ...
    private static final String PLUGIN_NAME = "dynamic_synonym";
    ...
    private void createIndexWithDbSynonym(String indexName) {
        final String indexSettings = "{\n" +
                "  \"index\":{\n" +
                "    \"analysis\":{\n" +
                "      \"filter\":{\n" +
    ...
    public void testDb() throws InterruptedException {
        String index = "test_db";
        createIndexWithDbSynonym(index);
        analyzer(index);
    }
}
